...
public class SplitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(SplitActivity.this, splitMeFull.class);
                    Bundle b = new Bundle();
                    if (Integer.valueOf(split_people.getText().toString()) > 35){
                        split_people.setText("35");
                        Toast.makeText(SplitActivity.this, "Max number is 16!", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            ...
            AlertDialog.Builder builderexit = new AlertDialog.Builder(SplitActivity.this);
